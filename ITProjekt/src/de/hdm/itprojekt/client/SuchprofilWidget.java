...
public class SuchprofilWidget extends Composite {
	...
	/*
	 * @TR Die Methode soll das SuchprofilWidget für die Eingabe eines neuen
	...
	public void werteEinfuegen(Vector<TestSuchprofil> v) {
		...
		//Die Auswahlfelder sollen die gespeicherten Werte des Suchprofils unveränderbar anzeigen.
		haarfarbe.setEnabled(false);
		geschlecht.setEnabled(false);
		raucher.setEnabled(false);
		
		//In den Dropdown-Feldern soll der jeweils gespeicherte Suchwert des gewählten Suchprofils angezeigt werden.
