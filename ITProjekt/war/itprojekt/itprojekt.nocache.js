...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "itprojekt" because\n';
  ...
  $wnd.__gwt_activeModules['itprojekt'] = {
    'moduleName' : 'itprojekt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/itprojekt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['itprojekt'].superdevmode = true;

  var expectedSuffix = '/itprojekt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + itprojekt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:itprojekt';
  var devModeSessionKey = '__gwtDevModeSession:itprojekt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/itprojekt/itprojekt.nocache.js';
  ...
  $wnd.__gwt_activeModules['itprojekt'].canRedirect = true;
  $wnd.__gwt_activeModules['itprojekt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/itprojekt?user.agent=' + ua + '&_callback=' + callback;
